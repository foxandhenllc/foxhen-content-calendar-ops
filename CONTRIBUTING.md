# Contributing to Content Calendar Ops

Content Calendar Ops is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A content operations board for ideas, assignments, approvals, publishing readiness, reuse notes, and schedule exports.
